...
Public Class ScoredNames
    ...
    Public Class ScoredNamesDataTable
        ...
        Private columnActiveIngredient As DataColumn

        Private columnDosageForm As DataColumn

        Private columnPotency As DataColumn

        Private columnRoute As DataColumn
        ...
        Friend ReadOnly Property ActiveIngredientColumn As DataColumn
            Get
                Return Me.columnActiveIngredient
            End Get
        End Property

        Friend ReadOnly Property DosageFormColumn As DataColumn
            Get
                Return Me.columnDosageForm
            End Get
        End Property

        Friend ReadOnly Property PotencyColumn As DataColumn
            Get
                Return Me.columnPotency
            End Get
        End Property

        Friend ReadOnly Property RouteColumn As DataColumn
            Get
        ...
        Default Public ReadOnly Property Item(ByVal index As Integer) As ScoredNamesRow
            Get
        ...
        Public Overloads Function AddScoredNamesRow(ByVal Name As String, ByVal PhoneticScore As Integer, ByVal OrthographicScore As Integer, ByVal MergedScore As Integer, ByVal RecordSourceId As String, ByVal ProductNameUid As String, ByVal ActiveIngredient As String, ByVal DosageForm As String, ByVal Potency As String, ByVal Route As String, ByVal IsDeleted As String) As ScoredNamesRow
            Dim rowScoredNamesRow As ScoredNamesRow = CType(Me.NewRow, ScoredNamesRow)
            rowScoredNamesRow.ItemArray = New Object() {Name, PhoneticScore, OrthographicScore, MergedScore, RecordSourceId, ProductNameUid, ActiveIngredient, DosageForm, Potency, Route, IsDeleted}
        ...
        Friend Sub InitVars()
            ...
            Me.columnActiveIngredient = Me.Columns("ActiveIngredient")
            Me.columnDosageForm = Me.Columns("DosageForm")
            Me.columnPotency = Me.Columns("Potency")
            Me.columnRoute = Me.Columns("Route")
        ...
        Private Sub InitClass()
            ...
            Me.columnActiveIngredient = New DataColumn("ActiveIngredient", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnActiveIngredient)
            Me.columnDosageForm = New DataColumn("DosageForm", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnDosageForm)
            Me.columnPotency = New DataColumn("Potency", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnPotency)
            Me.columnRoute = New DataColumn("Route", GetType(System.String), Nothing, System.Data.MappingType.Element)
            Me.Columns.Add(Me.columnRoute)
            Me.columnIsDeleted = New DataColumn("IsDeleted", GetType(System.String), Nothing, System.Data.MappingType.Element)
    ...
    Public Class ScoredNamesRow
        ...
        Public Property ActiveIngredient As String
            Get
                Try
                    Return CType(Me(Me.tableScoredNames.ActiveIngredientColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableScoredNames.ActiveIngredientColumn) = value
            End Set
        End Property
        ...
        Public Property DosageForm As String
            Get
                Try
                    Return CType(Me(Me.tableScoredNames.DosageFormColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableScoredNames.DosageFormColumn) = value
            End Set
        End Property
        ...
        Public Property Potency As String
            Get
                Try
                    Return CType(Me(Me.tableScoredNames.PotencyColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableScoredNames.PotencyColumn) = value
            End Set
        End Property
        ...
        Public Property Route As String
            Get
                Try
                    Return CType(Me(Me.tableScoredNames.RouteColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableScoredNames.RouteColumn) = value
            End Set
        End Property
        ...
        Public Property IsDeleted As String
            Get
                Try
                    Return CType(Me(Me.tableScoredNames.IsDeletedColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableScoredNames.IsDeletedColumn) = value
            End Set
        End Property
        ...
        Public Function IsActiveIngredientNull() As Boolean
            Return Me.IsNull(Me.tableScoredNames.ActiveIngredientColumn)
        End Function

        Public Sub SetActiveIngredientNull()
            Me(Me.tableScoredNames.ActiveIngredientColumn) = System.Convert.DBNull
        End Sub

        Public Function IsDosageFormNull() As Boolean
            Return Me.IsNull(Me.tableScoredNames.DosageFormColumn)
        End Function

        Public Sub SetDosageFormNull()
            Me(Me.tableScoredNames.DosageFormColumn) = System.Convert.DBNull
        End Sub

        Public Function IsPotencyNull() As Boolean
            Return Me.IsNull(Me.tableScoredNames.PotencyColumn)
        End Function

        Public Sub SetPotencyNull()
            Me(Me.tableScoredNames.PotencyColumn) = System.Convert.DBNull
        End Sub

        Public Function IsRouteNull() As Boolean
            Return Me.IsNull(Me.tableScoredNames.RouteColumn)
        End Function

        Public Sub SetRouteNull()
            Me(Me.tableScoredNames.RouteColumn) = System.Convert.DBNull
        End Sub

        Public Function IsIsDeletedNull() As Boolean
            Return Me.IsNull(Me.tableScoredNames.IsDeletedColumn)
        End Function

        Public Sub SetIsDeletedNull()
            Me(Me.tableScoredNames.IsDeletedColumn) = System.Convert.DBNull
        End Sub
    End Class
    ...
    Public Class TextResultsDataTable
        ...
        Default Public ReadOnly Property Item(ByVal index As Integer) As TextResultsRow
            Get
        ...
        Public Overloads Function AddTextResultsRow(ByVal Name As String, ByVal RecordSourceId As String, ByVal ProductNameUid As String, ByVal ActiveIngredient As String, ByVal DosageForm As String, ByVal Potency As String, ByVal Route As String) As TextResultsRow
            Dim rowTextResultsRow As TextResultsRow = CType(Me.NewRow, TextResultsRow)
            rowTextResultsRow.ItemArray = New Object() {Name, RecordSourceId, ProductNameUid, ActiveIngredient, DosageForm, Potency, Route}
    ...
    Public Class TextResultsRow
        ...
        Public Property ActiveIngredient As String
            Get
                Try
                    Return CType(Me(Me.tableTextResults.ActiveIngredientColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableTextResults.ActiveIngredientColumn) = value
            End Set
        End Property
        ...
        Public Property DosageForm As String
            Get
                Try
                    Return CType(Me(Me.tableTextResults.DosageFormColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableTextResults.DosageFormColumn) = value
            End Set
        End Property
        ...
        Public Property Potency As String
            Get
                Try
                    Return CType(Me(Me.tableTextResults.PotencyColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableTextResults.PotencyColumn) = value
            End Set
        End Property
        ...
        Public Property Route As String
            Get
                Try
                    Return CType(Me(Me.tableTextResults.RouteColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableTextResults.RouteColumn) = value
            End Set
        End Property
        ...
        Public Property IsDeleted As String
            Get
                Try
                    Return CType(Me(Me.tableTextResults.IsDeletedColumn), String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set(ByVal value As String)
                Me(Me.tableTextResults.IsDeletedColumn) = value
            End Set
        End Property
        ...
        Public Function IsActiveIngredientNull() As Boolean
            Return Me.IsNull(Me.tableTextResults.ActiveIngredientColumn)
        End Function

        Public Sub SetActiveIngredientNull()
            Me(Me.tableTextResults.ActiveIngredientColumn) = System.Convert.DBNull
        End Sub

        Public Function IsDosageFormNull() As Boolean
            Return Me.IsNull(Me.tableTextResults.DosageFormColumn)
        End Function

        Public Sub SetDosageFormNull()
            Me(Me.tableTextResults.DosageFormColumn) = System.Convert.DBNull
        End Sub

        Public Function IsPotencyNull() As Boolean
            Return Me.IsNull(Me.tableTextResults.PotencyColumn)
        End Function

        Public Sub SetPotencyNull()
            Me(Me.tableTextResults.PotencyColumn) = System.Convert.DBNull
        End Sub

        Public Function IsRouteNull() As Boolean
            Return Me.IsNull(Me.tableTextResults.RouteColumn)
        End Function

        Public Sub SetRouteNull()
            Me(Me.tableTextResults.RouteColumn) = System.Convert.DBNull
        End Sub

        Public Function IsIsDeletedNull() As Boolean
            Return Me.IsNull(Me.tableTextResults.IsDeletedColumn)
        End Function

        Public Sub SetIsDeletedNull()
            Me(Me.tableTextResults.IsDeletedColumn) = System.Convert.DBNull
        End Sub
    End Class
