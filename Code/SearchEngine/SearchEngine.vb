...
<Serializable()> _
    ...
    Public Sub New()
        ...
        ' Spelling search
        'Me.m_SpellingSearch = False
        'Me.m_SpellingWeight = -1
    End Sub
    ...
    ' Spelling Search
    'Public Property SpellingWeight() As Integer
    '    Get
    '        Return Me.m_SpellingWeight
    '    End Get
    '    Set(ByVal Value As Integer)
    '        Me.m_SpellingWeight = Value
    '    End Set
    'End Property

    ' Spelling Search
    'Public Property SpellingSearch() As Boolean
    '    Get
    '        Return Me.m_SpellingSearch
    '    End Get
    '    Set(ByVal Value As Boolean)
    '        Me.m_SpellingSearch = Value
    '    End Set
    'End Property
    ...
    'Spelling Search
    'Private m_SpellingSearch As Boolean
    'Private m_SpellingWeight As Integer
End Class
