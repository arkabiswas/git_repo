...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<uc1:trackingheader id="TrackingHeader1" title="Modify Pick List Values" runat="server" location="<a href='Settings.aspx' alt='Click Here to return to the settings page.'>Return to Settings</a>"></uc1:trackingheader>
			<cc1:FDAGrid id="PickListGrid" style="Z-INDEX: 101; LEFT: 45px; POSITION: absolute; TOP: 154px" runat="server" ForeColor="Black" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" CellSpacing="2" IsSortedAscending="True" AllowSorting="True" CellPadding="2" PageSize="7" GridLines="Horizontal" Font-Size="120%" Font-Names="Verdana" AllowPaging="False" AutoGenerateColumns="False">
			...
			<asp:Label id="ErrorLabel" style="Z-INDEX: 102; LEFT: 44px; POSITION: absolute; TOP: 316px" runat="server" ForeColor="Red" Width="325px"></asp:Label>
			<asp:Label id="Label1" style="Z-INDEX: 103; LEFT: 50px; POSITION: absolute; TOP: 120px" runat="server" Width="220px">Modify the Level of Concern Picklist</asp:Label></form>
	</body>
</HTML>
