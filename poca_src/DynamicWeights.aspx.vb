...
#End Region
    ...
    Private Sub User_Set_Weights()
        ...
        Dim Phon_Value, Ortho_Value, Afax_Value As Double

        Try
            If PWeight.Text.Trim = "" Then
                MessageLabel.Text = "Please enter Phonetic Dynamic Weight and try again."
                Return
            End If
            If Oweight.Text.Trim = "" Then
                MessageLabel.Text = "Please enter Orthographic Dynamic Weight and try again."
                Return
            End If
            If Aweight.Text.Trim = "" Then
                MessageLabel.Text = "Please enter Additional Factors Dynamic Weight and try again."
                Return
            End If

            Phon_Value = CType(PWeight.Text, Double)
            Ortho_Value = CType(Oweight.Text, Double)
            Afax_Value = CType(Aweight.Text, Double)
