...
#End Region
    ...
    Private Sub btnImageButton_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnImageButton.Click
        ...
        Dim PageResultsVal As String = txtPageResults.Text.Trim
        Dim DisplayError As Boolean = False

        If PageResultsVal = "" Then
            DisplayError = True
        End If

        If PageResultsVal.Contains("$") Or PageResultsVal.Contains(".") Then
            DisplayError = True
        Else
            If IsNumeric(PageResultsVal) = False Then
                DisplayError = True
            Else
                Dim val As Integer
                val = CType(PageResultsVal, Integer)
                If val = 0 Then
                    DisplayError = True
                End If
            End If
        ...
        If DisplayError Then
            MessageLabel.Text = "Please enter a value between 1 and 99."
            MessageLabel.Visible = True
            MessageLabel.ForeColor = Color.Red
            Return
        End If
