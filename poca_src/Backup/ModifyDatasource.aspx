...
<HTML>
	<HEAD>
		...
		<style>#ModifyDatasourceList { FONT-SIZE: 12px; MARGIN: 55px 100px 0px; FONT-FAMILY: verdana }
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<poca:trackingheader id="TrackingHeader1" runat="server" location="<a href='Settings.aspx' title='Settings'>Return To Settings</a>" title="Modify Datasource Name" />		
				<table border="0" style="width: 447px; height: 89px; margin-left: 100px;">
                    <tr>
	                    <td>						
		                    <p>					                    
