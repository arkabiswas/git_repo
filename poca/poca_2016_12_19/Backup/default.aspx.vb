...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim LogFilePath As String = Server.MapPath("/ErrorLog/POCA.txt")
        ...
        If LoginPerson.User_Login(Session("POCA_User")) Then
            'If LoginPerson.User_Login("testuser") Then 'ADMINISTRATOR
            'If LoginPerson.User_Login("tuckerk") Then 'CC
            'If LoginPerson.User_Login("thomasmar") Then 'SE 
            'If LoginPerson.User_Login("govindarajan") Then
            'If LoginPerson.User_Login("TEST") Then
    ...
    '        If LoginPerson.User_Login(txtLogin.Text, txtPassword.Text) Then
