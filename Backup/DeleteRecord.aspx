...
<html>
  ...
  <body>
    ...
    <form id="Form1" method="post" runat="server">
		<uc1:TrackingHeader id="TrackingHeader1" runat="server" title="Delete a Record" location="<a href='Settings.aspx'>Return to Settings</a>"></uc1:TrackingHeader>
			...
			<asp:datagrid id="searchResults" 
				...
				<columns>				
					...
					<asp:TemplateColumn ItemStyle-Width="2%" HeaderText=" ">
					    <ItemTemplate>
					    <asp:RadioButton ID="rdoData" runat="server"  />
					    </ItemTemplate>
					</asp:TemplateColumn>
