...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Session("LoggedInUser") Is Nothing Then
            'lblReturnText.Text = "<a href='default.aspx' style='font-size: 14px; font-weight: bold;' title='Return to Login Screen'>Return to Login Screen</a>"
            TrackingHeader1NoNav.Location = "<a href='default.aspx' style='font-size: 14px; font-weight: bold;' title='Return to Login Screen'>Return to Login Screen</a>"
        ...
        Else
            'lblReturnText.Text = "<a href='Home.aspx' style='font-size: 14px; font-weight: bold;' title='Return Home'>Return Home</a>"
            TrackingHeader1NoNav.Location = "<a href='Settings.aspx' style='font-size: 14px; font-weight: bold;' title='Click here to return to settings'>Return to Settings</a>"
        End If
    ...
    Private Function ChangePassword(ByVal username As String, ByVal old_password As String, ByVal new_password As String, ByVal userid As String) As Boolean
        ...
        If Page.IsValid Then
            ...
            'First check if the entered old_password is indeed user's correct current password. 
            Dim LoginPerson As New PPC.FDA.Person.PersonObject()
            If LoginPerson.User_Login_Public(username, old_password) = False Then
                lblLoginValidate.Text = "The Old Password you entered is not correct current passsword for Username " & username
