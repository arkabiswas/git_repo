...
#End Region
    ...
    Private Sub btnImageButton_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnImageButton.Click
        ...
        Dim ThresholdVal As String = txtThreshold.Text.Trim
        Dim DisplayError As Boolean = False

        If ThresholdVal = "" Then
            DisplayError = True
        End If

        If ThresholdVal.Contains("$") Or ThresholdVal.Contains(".") Then
            DisplayError = True
        Else
            If IsNumeric(ThresholdVal) = False Then
                DisplayError = True
            Else
                Dim val As Integer
                val = CType(ThresholdVal, Integer)
                If val = 0 Then
                    DisplayError = True
                End If
            End If
        ...
        If DisplayError Then
            MessageLabel.Text = "Please enter a threshold between 1 and 99."
            MessageLabel.Visible = True
            MessageLabel.ForeColor = Color.Red
            Return
        End If
